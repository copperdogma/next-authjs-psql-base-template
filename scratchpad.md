...
---
# Recommendations for AI-Targeted Documentation (Generated by AI Agent Jules)
...
*   **4. `project-reference.mdc`** (Existing - role clarified and emphasized)
    ...
    *   **Instruction:** Static docs will provide foundational knowledge; this file captures the evolving state and specifics of *this* template's implementation/instance.
...
*   **Succinctness:** Avoid verbose explanations of general concepts the AI should know. Focus on *how* they are applied *in this project*.
