...
describe('Task Collection Security Rules', () => {
  ...
  describe('Task Read Rules', () => {
    test('unauthenticated users cannot read tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
    ...
    test('users can read their own tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('users cannot read other users tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('admin users can read any task', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
  ...
  describe('Task Create Rules', () => {
    test('unauthenticated users cannot create tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('users can create tasks for themselves', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('users cannot create tasks for other users', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('admin users can only create tasks for themselves', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
  ...
  describe('Task Update Rules', () => {
    test('users can update their own tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('users cannot update other users tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
      ...
      const taskDoc = authenticatedContext.firestore().collection('tasks').doc('task2');
      await assertFails(taskDoc.update({
        title: 'Attempting to Update',
        description: 'This should fail',
      }));
    }));
    
    test('admin users can update any task', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
  ...
  describe('Task Delete Rules', () => {
    test('users can delete their own tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('users cannot delete other users tasks', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('admin users can delete any task', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
