...
describe('Firestore Security Rules', () => {
  ...
  describe('User Collection Rules', () => {
    test('unauthenticated users cannot read user profiles', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
    ...
    test('authenticated users can read their own profile', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('authenticated users cannot read other user profiles', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('admin users can read any user profile', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('unauthenticated users cannot create user profiles', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('authenticated users can create their own profile', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('authenticated users cannot create profiles for other users', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
  ...
  describe('Public Collection Rules', () => {
    test('unauthenticated users can read public documents', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('unauthenticated users cannot write to public documents', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('non-admin authenticated users cannot write to public documents', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
    ...
    test('admin users can write to public documents', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
  ...
  describe('Default Deny Rules', () => {
    test('accessing an undefined collection is denied', skipTestIfNoEmulator(async () => {
      if (!testEnv) {
        console.warn('Skipping test - Firebase emulator not initialized');
        return;
      }
